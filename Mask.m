...
files = [dir('*.tif');dir('.tiff')]; %there must be some way to do this outside of the
...
files = [dir('*.tif');dir('*.tiff')]; %Messier than I'd like, but don't seem to have other options on Windows
